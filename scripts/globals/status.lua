...
dsp.jp = {
    ...
    SUBTLE_SORCERY_EFFECT    = JPCATEGORY_BLM + 0x01, --spellcasting time -1%
    ELEMENTAL_SEAL_EFFECT    = JPCATEGORY_BLM + 0x02, --elemental magic emnity -3
    MAGIC_BURST_DMG_BONUS    = JPCATEGORY_BLM + 0x03, --magic burst dmg +1%
    MANA_WALL_EFFECT         = JPCATEGORY_BLM + 0x04, --mp consumed -1%
    BLM_MAGIC_ACC_BONUS      = JPCATEGORY_BLM + 0x05, --m.acc +1
    EMNITY_DOUSE_RECAST      = JPCATEGORY_BLM + 0x06, --recast -3sec
    MANAWELL_EFFECT          = JPCATEGORY_BLM + 0x07, --m.dmg +1
    MAGIC_BURST_EMNITY_BONUS = JPCATEGORY_BLM + 0x08, --emnity -1
    ...
    TRIPLE_ATTACK_EFFECT     = JPCATEGORY_THF + 0x09, --p.atk +1
    ...
    SOUL_ENSLAVEMENT_EFFECT  = JPCATEGORY_DRK + 0x01, --tp absorb +1%
    ARCANE_CIRCLE_EFFECT     = JPCATEGORY_DRK + 0x02, --dmg taken -1
    ...
    NETHER_VOID_EFFECT       = JPCATEGORY_DRK + 0x06, --absorb +2% abs-attri status +1/10
    ARCANE_CREST_DURATION    = JPCATEGORY_DRK + 0x07, --dur. +1s
    SCARLET_DLRIUM_DURATION  = JPCATEGORY_DRK + 0x08, --dur. +1s
    ENDARK_EFFECT            = JPCATEGORY_DRK + 0x09, --p.dmg p.atk p.acc +1
    ...
    ASTRAL_CONDUIT_EFFECT    = JPCATEGORY_SMN + 0x01, --BPR: dmg +1% BPW: duration +1%
    SUMMON_ACC_BONUS         = JPCATEGORY_SMN + 0x02, --pet p.acc +1
    SUMMON_MAGIC_ACC_BONUS   = JPCATEGORY_SMN + 0x03, --pet m.acc +1
    ELEMENTAL_SIPHON_EFFECT  = JPCATEGORY_SMN + 0x04, --mp recov. +3
    SUMMON_PHYS_ATK_BONUS    = JPCATEGORY_SMN + 0x05, --pet p.atk +2
    MANA_CEDE_EFFECT         = JPCATEGORY_SMN + 0x06, --pet tp +50
    AVATARS_FAVOR_EFFECT     = JPCATEGORY_SMN + 0x07, --favor +3s dur. bonus
