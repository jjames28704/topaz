...
function onUseAbility(player,target,ability)
    ...
    -- JP recovers MP
    local jp_value = player:getJobPointValue(tpz.jp.REPAIR_EFFECT)
    ...
    if jp_value then pet:addStatusEffect(tpz.effect.REFRESH,refreshAmount * jp_value,3,regenTime) end -- needs verification
    player:removeAmmo()
