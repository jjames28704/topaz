...
function onEffectGain(target, effect)
    ...
    target:addMod(tpz.mod.RANGED_DELAYP, -15 - target:getMod(tpz.mod.VELOCITY_SHOT_DELAY))
end
...
function onEffectLose(target, effect)
    ...
    target:delMod(tpz.mod.RANGED_DELAYP, -15 - target:getMod(tpz.mod.VELOCITY_SHOT_DELAY))
end
